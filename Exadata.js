...
import './Exadata.css';
import Exadata1 from './Exadata1.jpg';
        ...
        <div className="bg " >
            ...
            <div className="mars1">
                <div className="fontsez">
                    <p className="paras">With Enormous IT’s EXADATA Administration services, you gain access to specialized expertise in managing Oracle EXADATA systems, engineered for the optimal performance of Oracle databases. Our solutions are tailored to enhance database efficiency, reliability, and scalability.</p>
                </div>
                ...
                <div className="disg">
                    <div >
                        ...
                        <p className="paras" >To find out more about how our EXADATA Administration services can benefit your organization, reach out at

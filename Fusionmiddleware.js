...
import './Fusionmiddleware.css';
import fusionmain1 from './fusionmain1.jpg';
        ...
        <div className="bg " >
            ...
            <div className="mars1">
                <div className="ffontsz">
                    <p className="paras">Enormous IT’s Fusion Middleware services are designed to help organizations achieve seamless integration across disparate systems and applications. By leveraging Oracle's powerful middleware solutions, businesses can streamline operations, enhance collaboration, and drive innovation.</p>
                </div>

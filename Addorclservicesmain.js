...
import './Addorclservicesmain.css';
// import mainpg from './mainpg.jpg';
import oraclemainpage from './oraclemainpage.jpg';
import FUSION from './FUSION.jpeg';
import DBAS from './DBAS.jpeg';
import EXADATA from './EXADATA.jpeg';
import INTEGRATION from './INTEGRATION.jpeg';
// import { Link } from "react-router-dom";


function Addorclservicesmain() {
    return (
        <div >
            <div className="bg ">
                <div className="body">
                ...
                <div>
                    <p className="parass1" > Contact us today to discover how Enormous IT's comprehensive Oracle services can empower your organization. With our proven track record and commitment to innovation, we ensure your IT investments drive maximum value and support your growth initiatives effectively. Our personalized approach and dedication to customer satisfaction guarantee seamless integration and optimized performance across all Oracle solutions. Let us partner with you to navigate the complexities of modern IT landscapes and achieve sustainable success in your industry</p>
                </div>
            </div>
...
export default Addorclservicesmain;